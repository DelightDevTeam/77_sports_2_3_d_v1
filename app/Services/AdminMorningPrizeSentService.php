...
class AdminMorningPrizeSentService
{
    ...
    public function MorningPrizeSentForAdmin()
    {
        ...
        Log::info('Retrieving prize_sent data for date: '.$today.' and session: morning');
        ...
        try {
            ...
            Log::info('Number of results found: '.$results->count());

            // Calculate total prize amount
            $totalPrizeAmount = $results->sum(function ($result) {
                return $result->sub_amount * 85; // Prize multiplier
            });
